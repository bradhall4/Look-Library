...
| 002 | 2026-09-06 | Hype Williams | "Hype Flood" | archive | Rebuilt entirely 8 Sep and it now transfers. Renamed from "Fisheye Chrome Maximalism": the plates contain no fisheye and no chrome, and that title is what pulled the treatment string toward reputation in the first place. All four frames regenerated from a plate-derived string; coverage went from 43-65% to 77-98% and the curved corner-masked rendering vanished. Product: smart glasses, survives well against a flat colour field. |
